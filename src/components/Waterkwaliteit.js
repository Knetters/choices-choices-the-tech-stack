...
export default function Waterkwaliteit() {

    return (
        <section class="white-bg first-section">
            <div class="inner-section">
                <div class="horizontal-flex-row">
                    <div class="image-container">
                        ...
                        <img src="img/Aquathermie.png" alt="foto aquathermie" />
                    </div>
                    <div class="text-container top-text-margin">
